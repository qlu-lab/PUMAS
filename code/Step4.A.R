...
library(microbenchmark,lib.loc="/ua/wu638/R/x86_64-pc-linux-gnu-library/3.5")
...
write.table(summary(microbenchmark(main())),"/z/Comp/lu_group/Members/yixuan/PUMAS/test/step4a_test.txt",col.names = T,row.names=F,quote=F,sep="\t")
